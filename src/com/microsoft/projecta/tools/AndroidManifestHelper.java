...
public class AndroidManifestHelper {
    ...
    public static AndroidManifestHelper parseAndroidManifest(String apkPath) throws IOException,
            XmlPullParserException {
        ZipFile file = null;
        AndroidManifestHelper helper = null;
        try {
            ...
            helper = new AndroidManifestHelper();
